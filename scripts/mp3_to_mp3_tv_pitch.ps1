...
$Files = @(Get-ChildItem -LiteralPath $SourceRoot -Recurse -File -Filter "*.mp3")
...
foreach ($File in $Files) {
    ...
    try {
        ...
        # MP3 must be decoded to PCM for the pitch/speed change, then
        # encoded again. This necessarily introduces generation loss.
        $audioFilter = `
            "asetrate=$newRate," +
...
Write-Host ""
Write-Host "============================================================"
Write-Host "DONE - MP3 -> MP3 320 kbps"
Write-Host "============================================================"
